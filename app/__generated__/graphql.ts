...
export type AddRecipesMutation = { __typename?: 'Mutation', addRecipes: Array<{ __typename?: 'Recipe', name: string, ingredients: string, directions: string }> };
...
export type MenusQuery = { __typename?: 'Query', menus?: Array<{ __typename?: 'Menu', backgroundImage: string, courses: Array<{ __typename?: 'Course', name: string, description: string }> } | null> | null };
...
export type GenerateMenuQuery = { __typename?: 'Query', generateMenu: { __typename?: 'Menu', backgroundImage: string, courses: Array<{ __typename?: 'Course', name: string, description: string }> } };


export const AddRecipesDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"AddRecipes"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"recipes"}},"type":{"kind":"NonNullType","type":{"kind":"ListType","type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"RecipeInput"}}}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"addRecipes"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"recipes"},"value":{"kind":"Variable","name":{"kind":"Name","value":"recipes"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"ingredients"}},{"kind":"Field","name":{"kind":"Name","value":"directions"}}]}}]}}]} as unknown as DocumentNode<AddRecipesMutation, AddRecipesMutationVariables>;
